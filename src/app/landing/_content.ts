...
export const harga = {
  hero: {
    ...
    title: 'Mulai gratis dengan 5 credit. Perusahaan cukup satu paket flat.',
    lead: 'Pencari kerja dapat 5 credit gratis begitu daftar, lalu top up hanya Rp1.500 per credit kalau butuh lebih. Perusahaan cukup satu paket flat per bulan untuk seluruh tim HR.',
    ctas: [
  ...
  pricing: {
    eyebrow: 'Satu model harga, dua sisi',
    title: 'Simpel: gratis untuk mulai, credit kalau butuh lebih',
    lead: 'Tidak ada tingkatan paket yang membingungkan. Pencari kerja pakai sistem credit, perusahaan cukup satu paket flat.',
    list: [
      {
        name: 'Pencari Kerja',
        ...
        features: [
          ...
          'Top up credit hanya Rp1.500 / credit',
          'Credit dipakai untuk matching, skill gap report, dan roadmap belajar',
          'Tidak ada langganan atau tanggal kedaluwarsa',
        ],
        cta: { label: 'Mulai Gratis', href: '/register' },
      },
      {
        ...
        price: 'Rp1.500.000',
        unit: '/bulan',
        desc: 'Satu paket flat untuk seluruh tim HR, tanpa biaya tambahan per lowongan atau per kandidat.',
        features: [
          'Unlimited job posting',
          'Kandidat otomatis diranking & discoring',
          'Dashboard rekrutmen & analitik lengkap',
          'Akses penuh fitur AI matching',
        ],
    ...
    groups: [
      {
        ...
        items: [
          {
            q: 'Apa itu credit dan buat apa dipakai?',
            a: 'Credit adalah satuan yang dipakai tiap kali kamu menjalankan proses seperti job matching, skill gap report, atau roadmap belajar. Kamu dapat 5 credit gratis saat mendaftar, dan bisa top up lagi kapan saja seharga Rp1.500 per credit.',
          },
          {
            q: 'Apakah 5 credit gratis itu berlaku selamanya atau cuma sekali?',
            a: '5 credit gratis diberikan sekali di awal saat kamu mendaftar. Setelah habis, kamu bisa top up credit sesuai kebutuhan tanpa harus berlangganan.',
          },
          {
            q: 'Kenapa perusahaan bayar flat, bukan per lowongan atau per kandidat?',
            a: 'Supaya tim HR bisa merekrut sebanyak mungkin tanpa harus menghitung biaya per posting. Rp1.500.000 per bulan sudah termasuk unlimited job posting dan akses penuh ke fitur AI matching.',
          },
        ],
      },
    ] satisfies FaqGroup[],
  ...
  cta: {
    title: 'Masih ada pertanyaan soal harga?',
    lead: 'Ceritakan kebutuhanmu, tim kami bantu jelaskan lebih lanjut.',
    ctas: [
