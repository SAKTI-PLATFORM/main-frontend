...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      router.replace(role === 'JOB_SEEKER' ? ROUTES.JOB_SEEKER : ROUTES.RECRUITER)
    } catch (err: unknown) {
      const msg =
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-8 py-12 bg-white">
        <div className="w-full max-w-md flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-zinc-400">Or sign up with email</span>
            <div className="flex-1 h-px bg-zinc-200" />
          </div>
          ...
          <p className="text-sm text-zinc-600 text-center">
            ...
            <Link href={ROUTES.LOGIN} className="text-[#3535C8] font-semibold hover:underline">
              Login
            </Link>
          </p>
          ...
          <p className="text-xs text-zinc-500 text-center leading-relaxed">
            ...
            <span className="text-[#3535C8] cursor-pointer hover:underline">Terms of Service</span>{' '}
            and{' '}
            <span className="text-[#3535C8] cursor-pointer hover:underline">Privacy Policy</span>.
          </p>
        </div>
      </div>
    </div>
